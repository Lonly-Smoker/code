...
public class Article implements Serializable {
    ...
    private Integer articleId;  //资源类型id
    ...
    @Transient
    private String contentNoTag;  //资源内容  网页标签 luncene分词用到

    @Column(length = 200)
    private String download;    // 百度云地址

    @Column(length = 10)
    private String password;    // 百度云密码

    private boolean isHot=false;    // 是否热门资源

    private  Integer state; //状态：1未审核2审核通过3驳回
    ...
    private boolean isUseful=true; //资源连接是否有效
